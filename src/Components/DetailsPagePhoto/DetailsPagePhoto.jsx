    ...
    return (
        <div className="flex flex-col-reverse md:flex-row items-center justify-around gap-3 w-full">
            <div className="flex flex-row justify-around md:gap-4 md:flex-col ">
                ...
                {/* <div onClick={() => setImage(image1 ? image1 : imageURL1)} className="h-[50px] md:h-[100px] w-[50px] md:w-[100px] border-2 border-neutral-200 p-1 md:p-2 rounded-md cursor-pointer"><img className="h-full" src={image1 || imageURL1} alt="" /></div> */}
                
                {/* <div onClick={() => setImage(image2? image2:imageURL2)} className="h-[50px] md:h-[100px] w-[50px] md:w-[100px] border-2 border-neutral-200 p-1 md:p-2 rounded-md cursor-pointer">
                ...
                <div onClick={() => setImage(image3 ? image3 : imageURL3)} className="h-[50px] md:h-[100px] w-[50px] md:w-[100px] border-2 border-neutral-200 p-1 md:p-2 rounded-md cursor-pointer">
                    <img className="h-full w-full" src={image3 || imageURL3} alt="" />
                </div>
                {/* {
                ...
                <div onClick={() => setImage(image4 ? image4 : imageURL4)} className="h-[50px] md:h-[100px] w-[50px] md:w-[100px] border-2 border-neutral-200 p-1 md:p-2 rounded-md cursor-pointer">
                    <img className="h-full w-full" src={image4 || imageURL4} alt="" />
                </div>
                {/* {
                ...
                <div onClick={() => setImage(image5 ? image5 : imageURL5)} className="h-[50px] md:h-[100px] w-[50px] md:w-[100px] border-2 border-neutral-200 p-1 md:p-2 rounded-md cursor-pointer">
                    <img className="h-full w-full" src={image5 || imageURL5} alt="" />
                </div>
            </div>
