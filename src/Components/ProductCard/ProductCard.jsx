...
const ProductCard = ({ products }) => {
    ...
    return (
        <div className="w-28 md:w-64 lg:w-60 card card-compact bg-base-100 shadow-xl font-catamaran rounded-lg mx-1 md:mx-auto group">
            <Link to={`/product/${_id}`}>
                <figure className="">
                    <img className="h-[100px] md:h-[200px]" src={image1} alt={name} />
                </figure>
