        ...
        <div className="md:h-[508px] overflow-hidden flex flex-col md:flex-row items-center w-full md:gap-2 bg-gradient-to-r from-sky-400 via-sky-300 to-cyan-400 py-8">
            <div className="md:w-2/6">
                ...
                <div className="relative md:h-[500px]">
                    <img className="border-t-8 border-r-8 border-white h-[500px] md:h-full w-full " src="https://lh3.googleusercontent.com/drive-viewer/AKGpihagqKodU7j78K958td1knH4pTosgpaog8cr1nuMrojzNPxlip-EkNuU8XeFqVwzXk5gXJCkQespU4mPNUowGZQhIhvpnxOUgmk=s1600-rw-v1" alt="" />
